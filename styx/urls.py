...
urlpatterns = [
    ...
    url(r'^modules/realisation-etats/selectionner-dossiers/$', realisation_etats.select_doss, name = 'select_doss'),
    url(r'^modules/realisation-etats/selectionner-prestations/$', realisation_etats.select_prest, name = 'select_prest'),
