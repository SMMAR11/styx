...
L.drawLocal = {
    draw: {
        toolbar: {
            ...
            buttons: {
                polyline: 'Dessiner un linéaire',
                polygon: 'Dessiner une surface',
        ...
        handlers: {
            ...
            polygon: {
                tooltip: {
                    start: 'Cliquer pour démarrer le dessin de la surface.',
                    cont: 'Cliquer pour continuer le dessin de la surface.',
                    end: 'Cliquer pour continuer. Double-cliquer pour terminer.'
                }
            },
            polyline: {
                error: '<strong>Erreur :</strong> les lignes ne doivent pas se croiser',
                tooltip: {
                    start: 'Cliquer pour démarrer le dessin.',
                    cont: 'Cliquer pour continuer. Double-cliquer pour terminer.',
                    end: 'Cliquer pour continuer. Double-cliquer pour terminer.'
                }
            },
            rectangle: {
    ...
    edit: {
        toolbar: {
            actions: {
                ...
                cancel: {
                    title: 'Annuler l\'édition (annule tous les changements).',
                    text: 'Annuler'
                }
            },
            buttons: {
                edit: 'Editer les objets.',
                editDisabled: 'Pas d\'objets à éditer.',
                remove: 'Supprimer les objets.',
                removeDisabled: 'Pas d\'objets à supprimer.'
            }
        },
        handlers: {
            edit: {
                tooltip: {
                    text: 'Déplacer les points ou les poignées pour modifier les objets.',
                    subtext: 'Cliquer sur Annuler pour retablir.'
                }
            },
            remove: {
                tooltip: {
