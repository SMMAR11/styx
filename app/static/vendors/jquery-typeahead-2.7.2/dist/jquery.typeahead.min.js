    ...
    a.prototype = {
        extendOptions: function() {
            ...
            if (this.options.cache && (this.options.cache = function(t) {
                    ...
                    return e && t || !1
                }.call(this, this.options.cache)), this.options.compression && ("object" == typeof LZString && this.options.cache || (this.options.compression = !1)), "undefined" == typeof this.options.maxItem || /^\d+$/.test(this.options.maxItem) && 0 !== this.options.maxItem || (this.options.maxItem = 1 / 0), this.options.maxItemPerGroup && !/^\d+$/.test(this.options.maxItemPerGroup) && (this.options.maxItemPerGroup = null), this.options.display && !Array.isArray(this.options.display) && (this.options.display = [this.options.display]), this.options.group && (Array.isArray(this.options.group) || ("string" == typeof this.options.group ? this.options.group = {
        ...
        unifySourceFormat: function() {
            if (this.groupCount = 0, Array.isArray(this.options.source)) return this.options.source = {
                group: {
        ...
        delegateEvents: function() {
            var e = this,
                i = ["focus" + this.namespace, "input" + this.namespace, "propertychange" + this.namespace, "keydown" + this.namespace, "keyup" + this.namespace, "dynamic" + this.namespace, "generate" + this.namespace];
        ...
        generateRequestObject: function(t) {
            ...
            if ("function" != typeof i.ajax && (i.ajax instanceof Object && (o = this.extendXhrObject(o, i.ajax)), Object.keys(this.options.source).length > 1))
                for (var n in this.requests) this.requests.hasOwnProperty(n) && (this.requests[n].isDuplicated || o.request.url && o.request.url === this.requests[n].request.url && (this.requests[n].validForGroup.push(t), o.isDuplicated = !0, delete o.validForGroup));
            return o
        },
        ...
        handleRequests: function() {
            ...
            for (var o in this.requests) this.requests.hasOwnProperty(o) && (this.requests[o].isDuplicated || ! function(o, n) {
                ...
                var r, a = !1;
                if (~n.request.url.indexOf("{{query}}") && (a || (n = t.extend(!0, {}, n), a = !0), n.request.url = n.request.url.replace("{{query}}", encodeURIComponent(e.query))), n.request.data)
                ...
                t.ajax(n.request).done(function(t, i, o) {
                    ...
                    for (var a = 0, l = n.validForGroup.length; l > a; a++) r = e.requests[n.validForGroup[a]], r.callback.always instanceof Function && r.callback.always(t, o, s), "object" == typeof s && e.populateSource("function" == typeof t.promise && [] || t, r.extra.group, r.extra.path || r.request.path), i -= 1, 0 === i && e.helper.executeCallback.call(e, e.options.callback.onReceiveRequest, [e.node, e.query])
                }).then(function(t, i) {
        ...
        populateSource: function(t, e, i) {
            ...
            for (var r, a = n.display ? "compiled" === n.display[0] ? n.display[1] : n.display[0] : "compiled" === this.options.display[0] ? this.options.display[1] : this.options.display[0], l = 0, h = t.length; h > l; l++) null !== t[l] && "boolean" != typeof t[l] ? ("string" == typeof t[l] && (r = {}, r[a] = t[l], t[l] = r), t[l].group = e) : (_debug.log({
                node: this.node.selector,
                "function": "populateSource()",
                message: "WARNING - NULL/BOOLEAN value inside " + e + "! The data was skipped."
            }), _debug.print());
            if (!this.options.dynamic && this.dropdownFilter.dynamic.length)
                for (var c, p, u = {}, l = 0, h = t.length; h > l; l++)
                    for (var d = 0, f = this.dropdownFilter.dynamic.length; f > d; d++) c = this.dropdownFilter.dynamic[d].key, p = t[l][c], p && (this.dropdownFilter.dynamic[d].value || (this.dropdownFilter.dynamic[d].value = []), u[c] || (u[c] = []), ~u[c].indexOf(p.toLowerCase()) || (u[c].push(p.toLowerCase()), this.dropdownFilter.dynamic[d].value.push(p)));
        ...
        searchResultData: function() {
            var t, e, i, o, n, s, r, a, l, h, c, p, u, d = this,
                f = this.groupBy,
                y = null,
            ...
            for (t in this.source)
                if (this.source.hasOwnProperty(t) && (!this.filters.dropdown || "group" !== this.filters.dropdown.key || this.filters.dropdown.value === t)) {
                    ...
                    for (var k = 0, w = this.source[t].length; w > k && (!(this.result.length >= this.options.maxItem) || this.options.callback.onResult); k++)
                        if ((!v || this.dynamicFilter.validate.apply(this, [this.source[t][k]])) && (e = this.source[t][k], null !== e && "boolean" != typeof e && (!this.filters.dropdown || (e[this.filters.dropdown.key] || "").toLowerCase() === (this.filters.dropdown.value || "").toLowerCase()))) {
                            ...
                            for (var x = 0, C = n.length; C > x; x++)
                                if (s = /\./.test(n[x]) ? this.helper.namespace(n[x], e) : e[n[x]], "undefined" != typeof s && "" !== s) {
            ...
            if (this.options.resultContainer !== !1) {
                ...
                for (var r, a, l, h, c, p, u, d, f, y, g, m = this.groupTemplate && this.result.length && o.groups || [], v = 0, b = this.result.length; b > v; ++v) l = this.result[v], r = l.group, h = this.options.source[l.group].href || this.options.href, d = [], f = this.options.source[l.group].display || this.options.display, this.options.group && (r = l[this.options.group.key], this.options.group.template && ("function" == typeof this.options.group.template ? a = this.options.group.template(l) : "string" == typeof this.options.template && (a = this.options.group.template.replace(/\{\{([\w\-\.]+)}}/gi, function(t, e) {
                        ...
                        html: t("<a/>", {
                            ...
                            "data-index": v,
                            html: function() {
                                if (p = l.group && o.options.source[l.group].template || o.options.template) "function" == typeof p && (p = p.call(o, o.query, l)), u = p.replace(/\{\{([^\|}]+)(?:\|([^}]+))*}}/gi, function(t, e, n) {
                                    ...
                                    u = '<span class="' + o.options.selector.display + '">' + o.helper.cleanStringFromScript(String(d.join(" "))) + "</span>"
                                }(o.options.highlight === !0 && i && !p || "any" === o.options.highlight) && (u = o.helper.highlight.call(o, u, i.split(" "), o.options.accent)), t(this).append(u)
                            }
                        })
                    }),
                    function(e, i, n) {
                ...
                if (this.result.length && m.length)
                    for (var v = 0, b = m.length; b > v; ++v) n.find('[data-group-template="' + m[v] + '"]').remove();
                this.resultHtml = n
            }
        },
            ...
            if (this.options.hint) {
                ...
                if (this.options.accent && (n = this.helper.removeAccent.call(this, n)), this.hintIndex = null, this.query.length >= this.options.minLength) {
                    if (this.hint.container || (this.hint.css = t.extend({
                        ...
                        for (var s, r, a, l = 0, h = e.length; h > l; l++) {
                            r = e[l].group, s = this.options.source[r].display || this.options.display;
                            for (var c = 0, p = s.length; p > c; c++)
                                if (a = String(e[l][s[c]]).toLowerCase(), this.options.accent && (a = this.helper.removeAccent.call(this, a)), 0 === a.indexOf(n)) {
        ...
        buildDropdownItemLayout: function(e) {
            ...
            for (var l = 0, h = this.dropdownFilter[e].length; h > l; l++) {
                ...
                for (var c = 0, p = n.value.length; p >= c; c++)(c !== p || l === h - 1) && (c === p && l === h - 1 && "static" === e && this.dropdownFilter.dynamic.length || (o = this.dropdownFilterAll || r, n.value[c] ? o = n.template ? n.template.replace(new RegExp("{{" + n.key + "}}", "gi"), n.value[c]) : n.value[c] : this.container.find("." + s.options.selector.filterButton).html(o), function(e, o, n) {
                    a.append(t("<li/>", {
        ...
        dynamicFilter: {
            ...
            validate: function(t) {
                ...
                for (var s in this.filters.dynamic)
                    if (this.filters.dynamic.hasOwnProperty(s) && (i = ~s.indexOf(".") ? this.helper.namespace(s, t, "get") : t[s], "|" !== this.filters.dynamic[s].modifier || o || (o = i == this.filters.dynamic[s].value || !1), "&" === this.filters.dynamic[s].modifier)) {
        ...
        helper: {
            ...
            executeCallback: function(t, e) {
                if (t) {
                    ...
                    else if (("string" == typeof t || Array.isArray(t)) && ("string" == typeof t && (t = [t, []]), i = this.helper.namespace(t[0], window), "function" != typeof i)) return;
