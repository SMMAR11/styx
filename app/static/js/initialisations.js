...
$(document).ready(function()
{
	...
	tab_datatables =
	{
		...
		'choisir_prestation' : init_datatable($('#tab_choisir_prestation'), [6]),
		...
		'consulter_factures' : init_datatable($('#tab_consulter_factures'), [6]),
		'consulter_financements' : init_datatable($('#tab_consulter_financements'), [7]),
		'consulter_photos' : init_datatable($('#tab_consulter_photos'), [0, 4]),
		'consulter_prestations' : init_datatable($('#tab_consulter_prestations'), [6]),
		'consulter_reglementations' : init_datatable($('#tab_consulter_reglementations'), [5]),
