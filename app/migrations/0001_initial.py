# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2017-01-25 12:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mont_ht_ddv', models.FloatField(blank=True, null=True, validators=[app.validators.val_mont_pos], verbose_name='Montant HT de la demande de versement (en €)')),
                ('mont_ht_verse_ddv', models.FloatField(default=0, validators=[app.validators.val_mont_nul], verbose_name='Montant HT versé (en €)')),
                ('mont_ttc_ddv', models.FloatField(blank=True, null=True, validators=[app.validators.val_mont_pos], verbose_name='Montant TTC de la demande de versement (en €)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dt_int_doss', models.DateField(default=datetime.date(2017, 1, 25))),
                ('est_ttc_doss', models.BooleanField()),
                ('lib_1_doss', models.CharField(max_length=255, validators=[app.validators.val_cdc], verbose_name='Territoire ou caractéristique')),
                ('lib_2_doss', models.CharField(max_length=255, validators=[app.validators.val_cdc], verbose_name='Territoire ou lieu-dit précis')),
                ('mont_doss', models.FloatField(validators=[app.validators.val_mont_pos], verbose_name='Montant du dossier présenté au CD GEMAPI (en €)')),
                ('mont_suppl_doss', models.FloatField(default=0, validators=[app.validators.val_mont_nul], verbose_name='Dépassement du dossier (en €)')),
                ...
                ('id_av', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app.TAvancement', verbose_name="État d'avancement")),
                ('id_av_cp', models.ForeignKey(default=app.models.TDossier.set_id_av_cp_default, on_delete=django.db.models.deletion.DO_NOTHING, to='app.TAvisCp', verbose_name='Avis du comité de programmation - CD GEMAPI')),
                ('id_doss_ass', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='app.TDossier')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_doss', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.TDossier')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mont_ht_fact', models.FloatField(blank=True, null=True, validators=[app.validators.val_mont_pos], verbose_name='Montant HT de la facture (en €)')),
                ('mont_ttc_fact', models.FloatField(blank=True, null=True, validators=[app.validators.val_mont_pos], verbose_name='Montant TTC de la facture (en €)')),
                ...
                ('id_doss', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app.TDossier')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('courr_org', models.CharField(blank=True, max_length=255, null=True, validators=[app.validators.val_courr], verbose_name='Adresse électronique')),
                ...
                ('port_org', models.CharField(blank=True, max_length=10, null=True, validators=[app.validators.val_tel], verbose_name='Numéro de téléphone portable')),
                ('site_web_org', models.CharField(blank=True, max_length=255, null=True, verbose_name='Site web')),
                ('tel_org', models.CharField(blank=True, max_length=10, null=True, validators=[app.validators.val_tel], verbose_name='Numéro de téléphone')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_doss', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app.TDossier')),
                ('id_ppv_ph', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app.TPeriodePriseVuePhoto', verbose_name='Période de prise de vue')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ref_prest', models.CharField(blank=True, max_length=255, null=True, validators=[app.validators.val_cdc], verbose_name='Référence de la prestation')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_doss', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app.TDossier')),
                ('id_prest', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app.TPrestation')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='tdossier',
            name='id_techn',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app.TTechnicien'),
        ),
        migrations.AddField(
            model_name='tdossier',
            name='id_type_doss',
